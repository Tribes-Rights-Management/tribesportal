...
Check for:
1. IMPORT VIOLATIONS: Any imports from @/components/ui/* in a page file (should be @/components/platform-ui)
2. COLOR VIOLATIONS: Hardcoded hex colors (bg-[#...], text-[#...]), bg-white, bg-card used as panel/card backgrounds
3. COMPONENT VIOLATIONS: Raw <table>, raw <input>, raw <select> where platform-ui equivalents exist
4. PATTERN VIOLATIONS: One-off card/section/panel components that should use AppCard, AppSection, AppPanel
5. KIT MIXING: Importing from both @/components/console and @/components/platform-ui in the same file
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Line 3:  IMPORT — Button from @/components/ui/button → AppButton from @/components/platform-ui
