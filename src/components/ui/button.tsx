...
const buttonVariants = cva(
  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap transition-all duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0071E3] focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:opacity-40 disabled:cursor-not-allowed disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        // Primary: Neutral grey fill — visible on both grey canvas and white cards (NO BLACK)
        default: "bg-[var(--btn-bg)] text-[var(--btn-text)] font-medium hover:bg-[var(--btn-bg-hover)]",
        // Destructive: Red border on transparent
        ...
        outline: "bg-[var(--btn-outline-bg)] text-[var(--btn-text)] border border-[var(--btn-outline-border)] font-medium hover:bg-[var(--btn-outline-hover-bg)]",
        // Secondary: Same as outline
        secondary: "bg-[var(--btn-outline-bg)] text-[var(--btn-text)] border border-[var(--btn-outline-border)] font-medium hover:bg-[var(--btn-outline-hover-bg)]",
