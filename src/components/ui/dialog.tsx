...
>(({ className, children, hideDefaultClose = false, overlayClassName, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed inset-0 z-50 m-auto grid w-[calc(100%-2rem)] sm:w-full max-w-lg max-h-[85vh] h-fit gap-0 overflow-hidden duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 rounded-2xl bg-white p-8 border border-[var(--border-subtle)] shadow-xl",
        className,
      )}
      {...props}
    >
