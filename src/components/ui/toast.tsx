...
const toastVariants = cva(
  // Stripe/Mercury-grade: lighter padding (p-4) for subtle, non-blocking feedback
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      // Mobile-first: always visible on touch devices, hidden until hover on desktop
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 transition-opacity opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:focus:opacity-100 group-[.destructive]:text-red-300 hover:text-foreground group-[.destructive]:hover:text-red-50 focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600",
      className,
    )}
    toast-close=""
    {...props}
