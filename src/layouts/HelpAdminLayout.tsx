...
/**
 * HELP ADMIN LAYOUT — COMPANY-SCOPED INTERNAL TOOL
 * 
 * Layout for Help backend (article/category management).
 * Custom header with Help-specific branding.
 * 
 * NOT accessible to:
 * - External auditors
 * - Licensing users
...
export function HelpAdminLayout() {
  const navigate = useNavigate();
