...
/**
 * HELP WORKSTATION LAYOUT — UNIFIED APPSHELL PATTERN
 * 
 * ═══════════════════════════════════════════════════════════════════════════
...
export function HelpWorkstationLayout() {
  ...
  const moduleLabel = getModuleLabel("help");
    ...
    <AppShell
      ...
      headerContent={
        <ModuleHeader 
          ...
          mobileNav={isMobile ? <MobileModuleNav moduleLabel={moduleLabel} items={navItems} /> : undefined}
        />
      }
