...
/**
 * HOW ADMINISTRATION WORKS PAGE — Uses global ContentPageLayout standard
 * NO page-specific typography or spacing overrides.
 */
export default function HowPublishingAdminWorksPage() {
  return (
    <ContentPageLayout
      title="How Administration Works"
      lede="This page outlines how Tribes administers rights, licenses, and records—from initial intake through permanent documentation."
    >
      <section>
        <h2 className="text-foreground mb-4">Before Engagement</h2>
      ...
      <section>
        <h2 className="text-foreground mb-4">Onboarding</h2>
        <ul className="space-y-2">
          <li className="text-[15px] leading-relaxed text-muted-foreground flex items-start gap-3">
            <span className="text-muted-foreground/40 select-none">•</span>
      ...
      <section>
        <h2 className="text-foreground mb-4">Ongoing Administration</h2>
        <ul className="space-y-2">
          <li className="text-[15px] leading-relaxed text-muted-foreground flex items-start gap-3">
            <span className="text-muted-foreground/40 select-none">•</span>
      ...
      <section>
        <h2 className="text-foreground mb-4">Licensing Process</h2>
        <ul className="space-y-2">
          <li className="text-[15px] leading-relaxed text-muted-foreground flex items-start gap-3">
            <span className="text-muted-foreground/40 select-none">•</span>
      ...
      <section>
        <h2 className="text-foreground mb-4">Recordkeeping & Continuity</h2>
        <ul className="space-y-2">
          <li className="text-[15px] leading-relaxed text-muted-foreground flex items-start gap-3">
            <span className="text-muted-foreground/40 select-none">•</span>
