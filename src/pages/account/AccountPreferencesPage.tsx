...
export default function AccountPreferencesPage() {
  ...
  return (
    <>
      ...
      {/* Regional Settings */}
      <PlatformSettingsCard title="Regional" description="Time and date display preferences">
        <PlatformDetailRow
          icon={Globe}
          label="Time zone"
      ...
      <PlatformSettingsFooter>Some preferences may be enforced by workspace policies.</PlatformSettingsFooter>
