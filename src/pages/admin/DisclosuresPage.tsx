...
export default function DisclosuresPage() {
  ...
  return (
    <AppPageLayout title="Regulatory Disclosures">
      ...
      <AppTable columns={["15%", "18%", "15%", "15%", "8%", "9%", "12%", "8%"]}>
        <AppTableHeader>
          <AppTableRow header>
            <AppTableHead>Watermark</AppTableHead>
            <AppTableHead>Export Type</AppTableHead>
            <AppTableHead>Scope</AppTableHead>
            <AppTableHead>Generated By</AppTableHead>
            <AppTableHead align="right">Records</AppTableHead>
            <AppTableHead>Status</AppTableHead>
            <AppTableHead>Generated</AppTableHead>
