...
export default function DisclosuresPage() {
  ...
  return (
    <PlatformPageLayout title="Regulatory Disclosures">
      ...
      <PlatformTable columns={["15%", "18%", "15%", "15%", "8%", "9%", "12%", "8%"]}>
        <PlatformTableHeader>
          <PlatformTableRow header>
            <PlatformTableHead>Watermark</PlatformTableHead>
            <PlatformTableHead>Export Type</PlatformTableHead>
            <PlatformTableHead>Scope</PlatformTableHead>
            <PlatformTableHead>Generated By</PlatformTableHead>
            <PlatformTableHead align="right">Records</PlatformTableHead>
            <PlatformTableHead>Status</PlatformTableHead>
            <PlatformTableHead>Generated</PlatformTableHead>
            <PlatformTableHead align="center">Action</PlatformTableHead>
          </PlatformTableRow>
        </PlatformTableHeader>
        <PlatformTableBody>
          {loading ? (
            <PlatformTableEmpty colSpan={8}>
            ...
            <PlatformTableEmpty colSpan={8}>
              ...
              <p className="text-xs text-muted-foreground mt-1">{EMPTY_STATES.NO_DATA.description}</p>
            </PlatformTableEmpty>
          ) : (
            exports.map((exp) => (
              <PlatformTableRow key={exp.id} clickable onClick={() => openExportDetail(exp)}>
