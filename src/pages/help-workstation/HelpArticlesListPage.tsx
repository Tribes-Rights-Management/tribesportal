    ...
    <div className="flex-1 p-8">
      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="relative flex-1 max-w-xs">
          <Search className="absolute left-0 top-1/2 -translate-y-1/2 h-4 w-4 text-[#6B6B6B]" strokeWidth={1.5} />
          <input
            ref={searchInputRef}
            type="text"
            ...
            {articlesLoading && !showSearching ? (
              ...
              <tr>
                <td colSpan={5} className="text-center py-20">
                  {debouncedSearch ? (
                    <div>
                      <Search className="h-8 w-8 text-[#404040] mx-auto mb-3" strokeWidth={1.5} />
