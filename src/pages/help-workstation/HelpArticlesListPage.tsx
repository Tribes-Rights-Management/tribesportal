      ...
      <div className="flex items-center gap-4 mb-6">
        <div className="relative flex-1 max-w-sm">
          ...
          <input
            ...
            className="w-full h-10 pl-10 pr-4 bg-card border border-border rounded text-[13px] text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-ring"
          />
        </div>
        <select
          value={statusFilter}
          onChange={(e) => { setStatusFilter(e.target.value); setCurrentPage(1); }}
          className="h-10 px-3 bg-card border border-border rounded text-[13px] text-foreground focus:outline-none focus:border-ring"
        >
